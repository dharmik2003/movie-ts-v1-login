...
import { setname, setPhonenumber, setemail, setPassword } from '../Redux/Slice/SignupSlice';
                    ...
                    <div className='main-cont'>
                        ...
                        <div className='signup-details'>
                            <div className='details-split'>
                                ...
                                <div>
                                    <NavLink to={'/'} onClick={handleSignupClick}><h3 className='signup-but'>Sign Up</h3></NavLink>
                                </div>
                                <div>
